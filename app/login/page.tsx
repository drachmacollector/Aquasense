...
import { Eye, EyeOff, Mail, Lock, Chrome, Waves } from "lucide-react"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 w-32 h-32 bg-blue-500/5 rounded-full blur-xl animate-float"
      ...
      <Card className="w-full max-w-md glass-strong bg-card/70 border-border/30 shadow-2xl relative z-10">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription className="text-muted-foreground">Sign in to your OceanData account</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <Button
            variant="outline"
            className="w-full glass bg-card/30 border-border/50 hover:bg-card/50 hover:border-border/70 transition-all duration-300 group"
            onClick={handleRipple}
          >
            {ripples.map((ripple) => (
              <span
